...
def message():
    ...
    print ('''{0} 
     ...
     ____ _____  ____ _____ _   _ _  __     _  ___  _     _____ ____  
{0} | __ )___ / / ___|___ /| \ | | |/ /    | |/ _ \| |   | ____|  _ \ 
{0} |  _ \ |_ \| |  _  |_ \|  \| | ' /  _  | | | | | |   |  _| | |_) |  v2.1
{0} | |_) |__) | |_| |___) | |\  | . \ | |_| | |_| | |___| |___|  _ < 
{0} |____/____/ \____|____/|_| \_|_|\_(_)___/ \___/|_____|_____|_| \_\   {1}

                   	    
			 [ kamikaze{0}gmx{1} from j3mbut{1}kud4 ]

-> github.com/kamikazegmx
